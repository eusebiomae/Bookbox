    ...
    <div class="page">
        ...
        <header class="section page-header header-creative-wrap context-dark">
            <div class="rd-navbar-wrap">
				...
				{{-- Banner Index --}}
        <section id="banner_index" class="section swiper-container swiper-slider swiper-slider-4" data-loop="true">
        ...
        <!-- Pilares-->
        <section id="pilars" class="section section-xxl bg-image-1">
            <div class="container">
        ...
        <section id="boxes" class="section section-xxl bg-default" style="background-color: #f7af69;">
            <div class="container">
				...
				{{-- Box avulso --}}
        <section id="single_box" class="section section-xxl bg-default">
            <div class="container">
        ...
        {{-- <section class="section section-xxl bg-image-1">
            <div class="container">
				...
				{{-- Our team --}}
				<section id="our_team" class="section section-xxl bg-image-1">
					<div class="container">
							<h2 class="text-transform-capitalize wow fadeScale">Nossos cosultores</h2>
							<!-- Owl Carousel-->
							<div class="owl-carousel owl-style-9" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="4" data-margin="30" data-dots="true" data-mouse-drag="false">
									<article class="team-modern box-sm wow slideInUp">
											<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Renata.png')}}" alt="" width="270" height="227" /></a>
