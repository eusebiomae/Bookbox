...
{{-- <section id="single_box" class="section section-xxl swiper-slide-pilars" style="background-image: url('{{$item['image_bg']}}');">
	<div class="parallax"> --}}
	<div class="container">
		<h4 class="text-transform-none wow fadeScale" style="margin-top: 25px; color: #96cd9b;">Transformações de impacto no seu dia a dia.</h4>
		<h4 class="text-transform-none wow fadeScale" style="color: #96cd9b;">Sua felicidade depende da sua saúde e vitalidade.</h4>
