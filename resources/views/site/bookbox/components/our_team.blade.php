...
<section id="our_team" class="section section-xxl swiper-slide-pilars" style="background-image: url('{{$item['image_bg']}}');">
	<div class="container">
			<h2 class="text-transform-capitalize wow fadeScale">Nossos curadores</h2>
			<p class="" style="padding: 15px;">Nossa equipe é formada por médicos e especialistas focados na Medicina do Estilo de Vida, entendem que a saúde integral é o futuro e que manter hábitos saudáveis é a melhor forma de prevenir doenças e viver mais e com qualidade, que é o que todos nós queremos, não é mesmo? </p>
			<!-- Owl Carousel-->
			<div class="owl-carousel owl-style-9" data-items="1" data-sm-items="2" data-md-items="3" data-lg-items="6" data-margin="30" data-dots="true" data-mouse-drag="false" style="margin-bottom: -100px">
					<article class="team-modern box-sm wow slideInUp">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Ivana.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".1s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Rafael.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".2s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Vanessa-Oliveira.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Fernando.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Lygia.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Ben.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Caroline.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Elaine.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Fernanda.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Camila.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Cristiane.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Karla-Fabiana.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Fredy.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Marta.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Maria-Luiza.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Maxwili.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Renata.png')}}" alt="" style="width: 150px" /></a>
					...
					<article class="team-modern box-sm wow slideInUp" data-wow-delay=".3s">
							<a class="team-modern-figure" href="#"><img src="{{ url ('assets/images/site/perfil/Rose.png')}}" alt="" style="width: 150px" /></a>
