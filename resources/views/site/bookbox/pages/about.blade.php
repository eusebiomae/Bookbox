                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="#">Pages</a>
                      <ul class="rd-menu rd-navbar-dropdown">
                        <li class="rd-dropdown-item active"><a class="rd-dropdown-link" href="about-us.html">About Us</a>
                        </li>
      ...
      <section class="breadcrumbs-custom">
        <div class="parallax-container" data-parallax-img="images/bg-about.jpg">
          <div class="breadcrumbs-custom-body parallax-content context-dark">
            <div class="container">
              <h2 class="text-transform-capitalize breadcrumbs-custom-title">Sobre nós</h2>
              <h5 class="breadcrumbs-custom-text">Lorem ipsum lorem de mais lorem<br class="d-none d-md-block">lorem lorem mais lorem ipsum lorem..</h5>
            </div>
          </div>
        </div>
            ...
            <div class="col-md-11 col-lg-6 col-xl-5">
              ...
              <article class="quote-classic-big inset-xl-right-30">
                <div class="heading-3 text-transform-capitalize quote-classic-big-text">
                  <div class="q">Fresh &amp; organic drinks for you</div>
                </div>
              </article>
              <!-- Bootstrap tabs-->
        ...
        <div class="container-fluid">
          ...
          <div class="slick-history">
            ...
            <div class="slick-slider child-carousel" data-items="1" data-sm-items="2" data-md-items="2" data-lg-items="3" data-xl-items="3" data-xxl-items="4" data-arrows="true" data-for="#carousel-parent-2" data-loop="false" data-focus-select="false">
              ...
              <div class="item">
                <div class="heading-5 box-info-classic-year">2020</div>
              </div>
            </div>
          </div>
        </div>
