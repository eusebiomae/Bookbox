                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item active"><a class="rd-nav-link" href="grid-shop.html">Shop</a>
                      <ul class="rd-menu rd-navbar-dropdown">
                        ...
                        <li class="rd-dropdown-item active"><a class="rd-dropdown-link" href="single-product.html">Single Product</a>
                        </li>
                      </ul>
                    </li>
      ...
      <section class="breadcrumbs-custom">
        <div class="parallax-container" data-parallax-img="images/bg-about.jpg">
          <div class="breadcrumbs-custom-body parallax-content context-dark">
            <div class="container">
              <h2 class="text-transform-capitalize breadcrumbs-custom-title">Detalhes do Box</h2>
              <h5 class="breadcrumbs-custom-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry <br class="d-none d-md-block">Lorem Ipsum is simply dummy text of the printing and typesetting industry. </h5>
            </div>
          </div>
        </div>
          ...
          <div class="row row-30">
            ...
            <div class="col-lg-6">
              <div class="single-product">
                <h3 class="text-transform-none font-weight-medium">Forest Berry</h3>
                <div class="group-md group-middle">
                  <div class="single-product-price">$18</div>
                ...
                <ul class="list list-description">
                  <li><span>Categories:</span><span>Smoothies</span></li>
                  <li><span>Weight:</span><span>100 ml</span></li>
                  <li><span>Box:</span><span>20 x 20 x 50 cm</span></li>
                </ul>
                <div class="group-xs group-middle">
                  <div class="product-stepper">
                    <input class="form-input" type="number" data-zeros="true" value="1" min="1" max="1000">
                  </div>
                  <div><a class="button button-lg button-secondary button-zakaria" href="#">Add to cart</a></div>
                </div>
                <hr class="hr-gray-100">
