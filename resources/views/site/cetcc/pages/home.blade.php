            ...
            <div class="container">
                <div class="row row-30 row-md-60 row-lg-70 justify-content-center align-items-md-center">
                            ...
                            <div class="product-wrap-1 bg-image-1 block-1">
                                ...
                                <div class="owl-carousel owl-style-5" data-items="1" data-margin="30" data-dots="true"
                                    ...
                                    <article class="product-creative">
                                        <div class="product-figure"><img
                                                src="{{ url('assets/images/product-big-1-470x324.png') }}" alt=""
                                                width="470" height="324" />
                                        </div>
                                        <h4 class="product-creative-title"><a href="single-product.html">Aurore
                                                Grape</a></h4>
                                    ...
                                    <article class="product-creative">
                                        <div class="product-figure"><img
                                                src="{{ url('assets/images/product-big-2-470x324.png') }}" alt=""
                                                width="470" height="324" />
                                        </div>
                                        <h4 class="product-creative-title"><a href="single-product.html">Banana
                                                Berry</a></h4>
                                        <div class="product-creative-price-wrap">
                                            <div class="product-creative-price product-creative-price-old">$18.00</div>
                                            <div class="product-creative-price">$13.00</div>
                                        </div>
                                    </article>
                                    <article class="product-creative">
                                        <div class="product-figure"><img
                                                src="{{ url('assets/images/product-big-3-470x324.png') }}" alt=""
                                                width="470" height="324" />
                                        </div>
                                        <h4 class="product-creative-title"><a href="single-product.html">Chili
                                                Mango</a></h4>
                                        <div class="product-creative-price-wrap">
                                            <div class="product-creative-price product-creative-price-old">$30.00</div>
                    ...
                    <div class="col-md-7 col-xl-6">
                        <h2 class="text-transform-capitalize wow fadeInRight">Why Organic?</h2>
                        <!-- Bootstrap collapse-->
                            ...
                            <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".1s">
                                <div class="card-header" role="tab">
                                    <div class="card-title"><a id="accordion1-card-head-qteehppu"
                                            ...
                                            role="button">Organic drinks contain more antioxidants.
                                ...
                                <div class="collapse show" id="accordion1-card-body-unqfdlnh"
                                    ...
                                    role="tabpanel">
                                    <div class="card-body">
                                        <p>There are many substances that can act as antioxidants; chief among them are
                                            vitamins A and C, as well as beta-carotene and manganese. A lack of
                                            antioxidant-rich foods can lead to a greater risk of atherosclerosis.</p>
                                    </div>
                                </div>
                            </article>
                            <!-- Bootstrap card-->
                            <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".2s">
                                <div class="card-header" role="tab">
                                    <div class="card-title"><a class="collapsed"
                                            ...
                                            role="button">Organic drinks are better for the environment.
                                            <div class="card-arrow">
                                                <div class="icon"></div>
                                            </div>
                                        </a></div>
                                ...
                                <div class="collapse" id="accordion1-card-body-eephkkca"
                                    ...
                                    role="tabpanel">
                                    <div class="card-body">
                                        <p>While you’re helping yourself be as healthy as can be, how about helping the
                                            environment and your fellow humans? Organic farming practices help conserve
                                            water and improve soil quality. Given the droughts we see
                                            occurring every year and the dire reports from environmental experts, these
                                            are no small reasons to go organic.</p>
                                    </div>
                                </div>
                            </article>
                            <!-- Bootstrap card-->
                            <article class="card card-custom card-corporate wow fadeInRight" data-wow-delay=".3s">
                                <div class="card-header" role="tab">
                                    <div class="card-title"><a class="collapsed"
                                            ...
                                            role="button">They’re higher in nutrients.
                                            <div class="card-arrow">
                                                <div class="icon"></div>
                                            </div>
                                        </a></div>
                                ...
                                <div class="collapse" id="accordion1-card-body-qbvvnoxx"
                                    ...
                                    role="tabpanel">
                                    <div class="card-body">
                                        <p>Along with fewer pesticides, this is probably the No. 1 reason folks decide
                                            to eat organic. Studies have shown that organic drinks are often higher in
                                            vitamin C, iron, magnesium, and phosphorous than their non-organic
                                            counterparts.
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-9">
                        <div class="slick-quote">
                            ...
                            <div class="slick-slider carousel-parent" id="carousel-parent" data-autoplay="true"
                                ...
                                <div class="item">
                                    <p class="quote-minimal-text">I’m very grateful to you for introducing me and my
                                        whole family to your extensive range of smoothies and organic juices. We are
                                        true fans and regular customers of your store!</p>
                                </div>
                                <div class="item">
                                    <p class="quote-minimal-text">I am amazed and extremely satisfied by your
                                        smoothies, their taste, and the customer service you provide to unexperienced
                                        clients who know nothing about organic drinks.</p>
                                </div>
                                <div class="item">
                                    <p class="quote-minimal-text">Your healthy drinks have a wonderful taste and the
                                        amazing selection of their flavors is what really attracts me in your store.
                                        Thank you for fast delivery and your fresh drinks!</p>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3 isotope-item" data-filter="Type 1">
                            ...
                            <article class="thumbnail-classic block-1">
                                <div class="thumbnail-classic-figure"><img
                                        src="{{ url('assets/images/masonry-gallery-1-270x250.jpg') }}" alt=""
                                        width="270" height="250" />
                                </div>
                                <div class="thumbnail-classic-caption">
                                    <div>
                                        <h5 class="thumbnail-classic-title"><a href="single-product.html">Lemon &amp;
                                                apple smoothie</a></h5>
                ...
                <div class="owl-carousel" data-items="1" data-sm-items="2" data-lg-items="3" data-margin="30"
                    ...
                    <article class="post post-classic box-md wow slideInDown">
                        <a class="post-classic-figure" href="blog-post.html"><img
                                src="{{ url('assets/images/post-1-370x239.jpg') }}" alt="" width="370"
                                height="239" /></a>
                        <div class="post-classic-content">
                            <div class="post-classic-time">
                                <time datetime="2020-08-09">August 9, 2020</time>
                            </div>
                            <h5 class="post-classic-title"><a href="blog-post.html">Can a Smoothie Supercharge Your
                                    Day?</a></h5>
                            <p class="post-classic-text">Most of us would agree – mornings are hectic. Getting yourself
                                and possibly others ready for the day ahead may...</p>
                        </div>
                    </article>
                    <!-- Post Classic-->
                    <article class="post post-classic box-md wow slideInUp">
                        <a class="post-classic-figure" href="blog-post.html"><img
                                src="{{ url('assets/images/post-2-370x239.jpg') }}" alt="" width="370"
                                height="239" /></a>
                        <div class="post-classic-content">
                            <div class="post-classic-time">
                                <time datetime="2020-08-09">August 9, 2020</time>
                            </div>
                            <h5 class="post-classic-title"><a href="blog-post.html">How to Make Your Breakfast Easy and
                                    Yummy</a></h5>
                            <p class="post-classic-text">Overloading your breakfast with calories may not be the best
                                idea but when you need a boost for the upcoming...</p>
                        </div>
                    </article>
                    <!-- Post Classic-->
                    <article class="post post-classic box-md wow slideInDown">
                        <a class="post-classic-figure" href="blog-post.html"><img
                                src="{{ url('assets/images/post-3-370x239.jpg') }}" alt="" width="370"
                                height="239" /></a>
                        <div class="post-classic-content">
                            <div class="post-classic-time">
                                <time datetime="2020-08-09">August 9, 2020</time>
                            </div>
                            <h5 class="post-classic-title"><a href="blog-post.html">Tips from Our Team: Making Yoghurts
                                    with Fresh Fruits</a></h5>
                            <p class="post-classic-text">Combining milk and fruits is the best solution for your daily
                                meal, whether it’s breakfast, lunch, or any other...</p>
                        </div>
                    </article>
                </div>
            </div>
