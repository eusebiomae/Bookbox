...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    <h2>Inserir Tipo de Alimentação</h2>
    <ol class="breadcrumb">
      <li>
        ...
        <a href="#">Configurações</a>
			...
			<li>
        <a href="{{ url('/admin/configuration/alimentationtype') }}">Tipo da alimentação</a>
      </li>
      <li class="active">
	...
	<div class="col-lg-12">
	  <div class="ibox float-e-margins">
	    <div class="ibox-title">
	      <h5>Post <small>Cadastro e edição da Categoria da alimentação.</small></h5>
	    </div>
	    <div class="ibox-content">
				<form name="formAlimentationType" method="post" action="{{ url($urlAction) }}" class="form-horizontal">
...
document.addEventListener('DOMContentLoaded', function() {
	try {
		APP.scope.alimentationType = <?=isset($data) ? json_encode($data) : 'null'?>;

		if (APP.scope.alimentationType) {
			populate(document.forms.formAlimentationType, APP.scope.alimentationType);
		}
	} catch (error) {
		console.warn(error);
	}
