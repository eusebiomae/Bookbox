...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-10">
		...
		<ol class="breadcrumb">
			...
			<li>
				<a href="{{ url('/admin/prospection/video') }}">Lista de Vídeos</a>
			</li>
			<li class="active">
...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="ibox float-e-margins">
		<div class="ibox-title">
			<h5>Vídeo <small>Cadastro de Vídeo.</small></h5>
		</div>
			...
			<form name="form" method="post" action="{{ url($urlAction) }}" enctype="multipart/form-data" class="form-horizontal">
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<input type="text" name="title" class="form-control" required {!! $fieldPageConfig->attr('title') !!} />
					...
					<div class="col-sm-6">
						...
						<input type="text" name="link" class="form-control" required {!! $fieldPageConfig->attr('link') !!} />
