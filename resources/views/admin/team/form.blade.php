...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    ...
    <ol class="breadcrumb">
      ...
      <li>
        <a href="{{ url('/admin/configurationTeam/team') }}">Equipe</a>
      </li>
      <li class="active">
        <strong>Inserir funcionário</strong>
      </li>
    </ol>
  </div>
  <div class="col-lg-2">
	...
	<div class="col-lg-12">
	  <div class="ibox float-e-margins">
	    <div class="ibox-title">
	      <h5>Equipe <small>Cadastro de funcionário.</small></h5>
	    </div>
	    <div class="ibox-content">
				<form name="formTeam" method="post" action="{{ $urlAction }}" enctype="multipart/form-data" class="form-horizontal">
...
document.addEventListener('DOMContentLoaded', function() {
	try {
		...
		APP.scope.team = <?=isset($data) ? json_encode($data) : 'null'?>;

		if (APP.scope.team) {
			populate(document.forms.formTeam, APP.scope.team);
		}
	} catch (error) {
		console.warn(error);
	}
