...
<p>Sua inscrição para a bolsa <strong>"{{ $data->scholarship->title }}"</strong> foi confirmada.</p>
<p>Aguarde o dia da prova...</p>

<div style="width: 100%; text-align: center; padding: 20px 0 0 0;">
	<a href="https://{{ request()->getHost() }}/student_area/scholarship"
		style="
